...
Система построена на архитектурном паттерне PCMEF с адаптацией под мобильную траекторию.

**Распределение слоёв:**

| Слой               | Расположение            | Ответственность                       |
|--------------------|-------------------------|---------------------------------------|
| Presentation (P)   | React Native (клиент)   | UI, отображение, ввод данных          |
| State Management   | React Native (клиент)   | Хранение состояния экранов (Redux)    |
| API Client         | React Native (клиент)   | HTTP-запросы к бэкенду                |
| Local Cache        | React Native (клиент)   | Кэширование (AsyncStorage)            |
...
| Foundation (F)     | Spring Boot             | Репозитории, доступ к БД, шлюзы       |
...
| Роль       | Возможности                                                                 |
|------------|-----------------------------------------------------------------------------|
| **Клиент** | Управление автопарком (CRUD транспортных средств, привязка водителей)       |
| **Диспетчер** | Просмотр событий, фильтрация, смена статуса, отправка команд водителям     |
| **Водитель** | Получение команд, подтверждение выполнения, push-уведомления               |
...
|-----------------------|---------------------------|
| Всего коммитов        | 60                        |
| Период разработки     | 15.02.2026 – 30.05.2026   |
...
- **Торубаров Максим Евгеньевич** — разработчик, документация  
  Группа ПИЖ-б-о-23-2, email: maxsimtorub@gmail.com, GitHub: [MaxTop60](https://github.com/MaxTop60)
